...
- 글자수 기준: 카페 서머리 1,800~2,200자(제목 포함) / 인스타 캡션 1,000~1,300자 내외(해시태그 없음).
- 캐러셀 10~14컷(공통 규칙 — 14컷 초과 금지, 개요 총 컷 수 = 실제 CUT 개수를 코드가 검증·보정. 수강생 모집형 역할 배치, 확장 구간에서 컷 수 조절), 캡쳐 가이드 5~8컷.
